...
class WinOrGoHome(object):
    ...
    def roundEnd(self, x, y, z):
        ...
        for name in mapped:
            ...
            wavePath=filePath+name[0]+","+str(name[1])+","+str(name[2])+","+str(name[3])+","+str(name[4])+'_'+ timestamp+".txt"
    ...
    def processing(self):
        ...
        print("time of get_obs:%fms"%((end - start) * 1000))
        ##########################byTAO
        # print(1)
        ...
        ##########################byTAO
        # print(sum(sum(self.audio_data[-1])))
        # if(sum(sum(self.audio_data[-1]))==0):
        #     self.audio_data=self.audio_data[:-1]
        #     self.myX=self.myX[:-1]
        #     self.myY=self.myY[:-1]
        #     self.oppX=self.oppX[:-1]
        #     self.oppY=self.oppY[:-1]
        # else:
